...
export default {
  data () {
    return {
      title: 'Hentaini | Studios & Producers'
    }
  },
  head () {
    return {
      ...
      meta: [
        ...
        { hid: 'og:description', property: 'og:description', content: 'Explore studios and producers in our comprehensive catalog' },
        { hid: 'og:url', property: 'og:url', content: 'https://hentaini.com/studios' },
