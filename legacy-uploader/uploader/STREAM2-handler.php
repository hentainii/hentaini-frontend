...
class STREAM2UploadAPI {
    ...
    public function getUploadServer() {
        try {
            $response = $this->client->get('https://api.streamwish.com/api/upload/server', [
    ...
    public function uploadFile($filePath, $fileName) {
        ...
        file_put_contents('STREAM2_fp.txt', print_r($filePath, true));
...
$tempDir = sys_get_temp_dir() . "/uploads-STREAM2/" . md5($fileName);
...
if ($chunkNumber + 1 == $totalChunks) {
    ...
    try {
        $api = new STREAM2UploadAPI($apiKey);
